...
void keyPressed() {
   //TASK 1: Enable screen key-commands to control animations
}
...
void saveGif() {
  //Task 3: enable saving gif action 
}

void end(){
    //Task 4: enable gif maker finish and exit
}
void run(){
  //Task 5: enable playing game action
}
